...
**风险警示与免责声明**：本文由 AI/大模型基于 [基金名称]（[基金代码]）已公开披露且可核查的基金年报、半年度报告、季度报告、招募说明书及其他监管披露文件辅助生成，仅用于个人投资研究与信息交流之目的。因 AI/大模型存在幻觉，本文不可避免地会产生不完全符合年报原文的情况，严重程度视 AI/大模型的幻觉程度而定，阅读本文后产生的任何观点需核对原文，使用本文内容所产生的任何直接或间接后果，均由使用者自行承担。
