...
| FB030 | FB030010 / FB030020 / FB030030 / FB030040 | 第一/二/三/四季度报告 | 季报 |

> 2026-08-17 实测修正：EID `reportDesp` 实际返回中文数字（"第一季度报告"…"第四季度报告"），此前记录为阿拉伯数字（"第1/2/3/4季度报告"）有误；`eid_downloader.py` 的 `QUARTERLY_REPORT_DESP_BY_QUARTER` 已同步修正。
