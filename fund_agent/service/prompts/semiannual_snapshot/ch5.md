...
item_rules:
  ...
  - condition: holder_structure 缺失
    affected_output: 持有人结构
    degradation_note: 持有人结构未抽取到时只声明证据缺口
...
请基于上述数据表格，写「风险与持有人」分析。要求：

### 结论要点
- **最关键的风险**：格式「最关键的风险是 [名称]」（1-2 个，注明结构性/阶段性）
- **风险分级**：高 / 中 / 低 + 依据
- **持有人结构**：户数 / 机构占比 / 个人占比（A 类优先）
